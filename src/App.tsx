...
function App() {
	...
	return (
		<div className="w-full min-h-full bg-black">
			<div className="w-full min-h-screen my-auto flex grid-cols-2 grid-rows-1 bg-[#000000]">
			...
			<div className="w-full min-h-fit flex grid-cols-2 grid-rows-1 bg-[#000000]">
				...
				<div className="w-[60%] col-span-1">
					<p className="pl-12 pt-8 text-4xl text-white">Description</p>
				</div>
			</div>
			...
			<div className="w-full h-fit">
				<div className="grid grid-cols-6 grid-rows-2 w-full">
					<div className="col-span-2 group h-80 w-80 [perspective:1000px] my-4 justify-self-end">
						<div className="relative h-full w-full rounded-2xl border-[8px] border-zinc-500 shadow-x1 transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(-180deg)]">
							<div className="absolute inset-0 rounded-xl">
								<img className="w-full h-full object-cover rounded-xl" src="transcendence.png" alt=""></img>
							</div>
					...
					<div className="col-span-2 group h-80 w-80 [perspective:1000px] mx-auto my-4">
						<div className="relative h-full w-full rounded-2xl border-[8px] border-zinc-500 shadow-x1 transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(-180deg)]">
							<div className="absolute inset-0 rounded-xl">
								<img className="w-full h-full object-cover rounded-xl" src="PureSlime.png" alt=""></img>
							</div>
							<div className="absolute inset-0 rounded-md bg-[#3e7ca8] h-full w-full text-center text-slate-200 [transform:rotateY(-180deg)] [backface-visibility:hidden]">
					...
					<div className="col-span-2 group h-80 w-80 [perspective:1000px] my-4">
						<div className="relative h-full w-full rounded-2xl border-[8px] border-zinc-500 shadow-x1 transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(-180deg)]">
							<div className="absolute inset-0 rounded-xl">
								<img className="w-full h-full object-cover rounded-xl" src="Cub3d.png" alt=""></img>
							</div>
							<div className="absolute inset-0 rounded-md bg-[#3e7ca8] h-full w-full text-center text-slate-200 [transform:rotateY(-180deg)] [backface-visibility:hidden]">
								<p className="text-4xl font-medium pt-6">Cub3d</p>
					...
					<div className="col-span-2 group h-80 w-80 [perspective:1000px] my-4 justify-self-end">
						<div className="relative h-full w-full rounded-2xl border-[8px] border-zinc-500 shadow-x1 transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(-180deg)]">
							<div className="absolute inset-0 rounded-xl">
								<img className="w-full h-full object-cover rounded-xl" src="Minesweeper.png" alt=""></img>
							</div>
							<div className="absolute inset-0 rounded-md bg-[#3e7ca8] h-full w-full text-center text-slate-200 [transform:rotateY(-180deg)] [backface-visibility:hidden]">
					...
					<div className="col-span-2 group h-80 w-80 [perspective:1000px] mx-auto my-4">
						<div className="relative h-full w-full rounded-2xl border-[8px] border-zinc-500 shadow-x1 transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(-180deg)]">
							<div className="absolute inset-0 rounded-xl">
								<img className="w-full h-full object-cover rounded-xl" src="So_Long.png" alt=""></img>
							</div>
							<div className="absolute inset-0 rounded-md bg-[#3e7ca8] h-full w-full text-center text-slate-200 [transform:rotateY(-180deg)] [backface-visibility:hidden]">
